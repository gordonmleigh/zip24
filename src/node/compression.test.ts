...
import { asyncIterable, base64, base64iterable } from "../test-util/data.ts";
import { maxChunkSize } from "../util/streams.ts";
import { defaultCompressors, defaultDecompressors } from "./compression.ts";

describe("node/compression", () => {
